...
| Insumo | Categoría | Fuente | Tipo | Cobertura |
|--------|-----------|--------|------|----------:|
| Comercios alta densidad | Diversidad | DENUE, INEGI | Puntos | 8,263 |
| Comercios media densidad | Diversidad | DENUE, INEGI | Puntos | 690 |
| Escuelas | Diversidad | Equipamiento INEGI | Puntos | 5,901 |
| Hospitales y centros de salud | Diversidad | Equipamiento INEGI | Puntos | 27 |
| Puntos WiFi gratuito | Digitalización | CDMX Abierta | Puntos | 70,419 |
| Estaciones de transporte | Proximidad | RNC | Puntos | 9,475 |
| Infraestructura ciclista | Proximidad | RNC | Líneas | 482 km |
| Rutas de transporte público | Proximidad | RNC | Líneas | 23,181 km |
...
3. Escuelas (CDMX)
4. Hospitales y centros de salud (CDMX)
5. Puntos WiFi gratuito (CDMX)
6. Estaciones de transporte público (CDMX)
7. Infraestructura ciclista — ciclovías (CDMX)
8. Rutas de transporte público (CDMX)
...
Los clústeres de transición o outliers (Bajo-Alto y Alto-Bajo) suman apenas 241 manzanas, lo que indica que los saltos abruptos entre zonas de alto y bajo acceso son escasos: la fragmentación territorial es gradual pero estructural.
